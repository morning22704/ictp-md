...
SRC=main.f90 io.f90 kinds.f90 constants.f90 memory.f90 threading.f90 utils.f90 \
	input.f90 restart.f90 control.f90 sysinfo.f90 atoms.f90 cell.f90 \
	pair.f90 pair_lj_cut.f90 neighbor.f90 units.f90
